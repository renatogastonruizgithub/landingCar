...
export default function Newsletter() {
    ...
    const handleSubmit = async (values, { resetForm }) => {
      try {
        const response = await fetch('https://web-django-templates.vercel.app/api/email/', {
          method: 'POST',
          headers: {
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        >
          ...
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
            {/* CTA content */}
            <div className="mb-6 lg:mr-16 lg:mb-0  lg:text-left ">
              <h3 className="h3 text-white mb-2">Solicita tu presupuesto</h3>
              <p className="text-purple-200 text-lg">
                En 24hs responderemos a tu consulta.
              </p>
            </div>
                  ...
                  <Form>
                    ...
                    <div className="flex flex-wrap -mx-3 mt-6">
                      <div className="w-full justify-center px-3">
                        <button
                          className="btn text-black bg-white hover:bg-purple-700 w-full lg:w-1/2"
                          type="submit"
